...
MailParser.prototype._processStateHeader = function(line) {
    ...
    if (!line.length) {
        ...
        if (textContent && ((!this._currentNode.meta.contentDisposition && !this._currentNode.meta.fileName) || this._currentNode.meta.contentDisposition == "inline")) {
            this._currentNode.attachment = false;
        } else if ((!textContent || ["attachment", "inline"].indexOf(this._currentNode.meta.contentDisposition) >= 0 || this._currentNode.meta.fileName) &&
